...
## Wie diese Wissensbasis funktioniert

- **`wissen/`** = Konsolidiertes Wissen pro Thema — **HIER lesen**
- **`quellen/`** = Rohdaten und Originalanalysen (Nachschlagewerk)
- **`incoming/`** = Neues Material ablegen, dann scannen
- Neues Material scannen: **"Scanne den incoming-Ordner"** sagen
...
### Hoch (vor Band-1-Launch schließen)
- [ ] Kategorien-Check in Rocket (Ghost-Categories, Bestseller-Schwelle)
- [ ] Reverse ASIN für Top-3 Workplace Romance auf amazon.de
...
- [ ] Monika Huber: Keine Keyword-/Konkurrenz-Recherche (Cozy Crime)
- [ ] Preis-Testing (0,99 € Launch vs. 4,99 € Dauer)
